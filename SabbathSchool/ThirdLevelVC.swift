...
var oneMoreLevelForFourth: Bool = false
var entityIdForFourth: Int16 = 0
var entityNameForFourth: String = ""

class ThirdLevelVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var header = [Header_More_Third_]()
    
    var more: [More_Third_]? {
        didSet{
    ...
    var entityId: Int32 = Int32(entityIdForThird)
    ...
    struct Storyboard {
        ...
        static let segueToMoreFourth = "SegueToMoreFourth"
    ...
    func loadHeader() {
        ...
        let presentRequest:NSFetchRequest<Header_More_Third_> = Header_More_Third_.fetchRequest()
    ...
    func getMore() {
        ...
        Alamofire.request(getInfoEndpoint, method: .post, parameters: getInfoParameters).responseObject { (response: DataResponse<superMore>) in
            ...
            case .success(let data):
                ...
                self.newHeader = NSEntityDescription.insertNewObject(forEntityName: "Header_More_Third_", into: self.contextObject)
                ...
                if let someMore = data.collectionEntity {
                    for _more in someMore {
                        ...
                        let appDel: AppDelegate = (UIApplication.shared.delegate as! AppDelegate)
                        self.contextObject = appDel.managedObjectContext
                        self.newMore = NSEntityDescription.insertNewObject(forEntityName: "More_Third_", into: self.contextObject)
    ...
    func getMoreCoreData() {
        ...
        let presentRequest:NSFetchRequest<More_Third_> = More_Third_.fetchRequest()
    ...
    func deleteRecords() -> Void {
        ...
        let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "More_Third_")
    ...
    func deleteHeader() -> Void {
        ...
        // Initialize Fetch Request
        let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "Header_More_Third_")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: Storyboard.moreCell, for: indexPath) as! ThirdTVCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if oneMoreLevelForFourth == true {
            
            if dateSegue?.entityId_ != nil {
                
                entityIdForFourth = (dateSegue?.entityId_)!
                entityNameForFourth = (dateSegue?.entityName_)!
            }
            
            self.performSegue(withIdentifier: Storyboard.segueToMoreFourth, sender: nil)
