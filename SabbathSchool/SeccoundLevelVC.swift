...
var entityIdForThird: Int16 = 0
var entityNameForThird: String = ""
var oneMoreLevelForThird: Bool = true

class SeccoundLevelVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var header = [Header_More_Seccound_]()
    ...
    var entityId: Int32 = Int32(entityIdForSeccound)
    ...
    struct Storyboard {
        ...
        static let segueToThirdMore = "SegueToThirdMore"
    ...
    func loadHeader() {
        ...
        let presentRequest:NSFetchRequest<Header_More_Seccound_> = Header_More_Seccound_.fetchRequest()
    ...
    func getMore() {
        ...
        Alamofire.request(getInfoEndpoint, method: .post, parameters: getInfoParameters).responseObject { (response: DataResponse<superMore>) in
            ...
            case .success(let data):
                ...
                self.newHeader = NSEntityDescription.insertNewObject(forEntityName: "Header_More_Seccound_", into: self.contextObject)
                ...
                if let someMore = data.collectionEntity {
                    for _more in someMore {
                        ...
                        let appDel: AppDelegate = (UIApplication.shared.delegate as! AppDelegate)
                        self.contextObject = appDel.managedObjectContext
                        self.newMore = NSEntityDescription.insertNewObject(forEntityName: "More_Seccound_", into: self.contextObject)
    ...
    func getMoreCoreData() {
        ...
        let presentRequest:NSFetchRequest<More_Seccound_> = More_Seccound_.fetchRequest()
    ...
    func deleteRecords() -> Void {
        ...
        let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "More_Seccound_")
    ...
    func deleteHeader() -> Void {
        ...
        // Initialize Fetch Request
        let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "Header_More_Seccound_")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: Storyboard.moreCell, for: indexPath) as! SeccoundTVCell
        ...
        func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            if oneMoreLevelForThird == true {
                
                if dateSegue?.entityId_ != nil {
                    
                    entityIdForThird = (dateSegue?.entityId_)!
                    entityNameForThird = (dateSegue?.entityName_)!
                }
                self.performSegue(withIdentifier: Storyboard.segueToThirdMore, sender: nil)
